...
def detect_teacher_bluetooth():
    ...
    teacher_device_name = "Teacher's Bluetooth Device"  # Replace with the actual name of the teacher's device
    ...
    if teacher_device_address:
        ...
        student_folder = 'path/to/student/images'  # Replace with the actual path to the student images folder
...
def send_attendance_data(attendance_data):
    ...
    server_url = "http://teacher-server-address:5000/record_attendance"
